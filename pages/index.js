      ...
      <div className="flex flex-col-reverse gap-3 lg:flex-row  items-center mt-2 mb-24">
        <div className="flex flex-col pr-10  text-center md:text-left">
          ...
          <div className="text-gray-600 mb-4 dark:text-gray-200">
            <p className="my-5">
              I'm a software developer who enjoys designing and building web
              apps - mainly using Next,React, Node, and Typescript.
            </p>
            <p className="leading-7">
              My favorite part about coding is the constant innovation of
              architectures, libraries, and frameworks. I think web development
              is experiencing a major breakthrough with headless architecture
              and jamstack, and want to be involved in any way I can.
            </p>
          </div>
